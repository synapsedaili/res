...
MODEL_NAME = "qwen3:4b"  # CPU için en ideal, zeki ve hızlı versiyon
...
def ask_qwen_to_evaluate_and_plan(current_findings):
    ...
    try:
        # TIMEOUT 300'DEN 1200'E (20 DAKİKA) ÇIKARILDI
...
def generate_final_report(all_findings):
    ...
    IMPORTANT: Be concise. Do not write long paragraphs. Use bullet points.
    ...
    **Total Findings Analyzed:** {len(all_findings)}
    ...
    payload = {
        ...
        "messages": [{"role": "user", "content": prompt}],
        "stream": False,
        # TOKEN LİMİTİ 2000'DEN 1000'E DÜŞÜRÜLDÜ (Daha hızlı rapor üretmesi için)
